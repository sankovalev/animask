...
from ..animask.core import Animask
...
class TestAnimask:
    ...
    @pytest.mark.parametrize("mask_color", [(1, 1, 1), (255, 0, 0), None])
    def test_animask_init(self, bg_beta, mask_color):
        """
    ...
    @pytest.mark.parametrize("bg_beta, mask_color", [
    ...
    def test_animask_init_bad_params(self, bg_beta, mask_color):
        """
    ...
    def test_animask_save(self, duration, with_background, with_annots):
        ...
        """
        animated = Animask(image=self.f_image, mask_color=(255, 0, 0))
        for file in self.f_masks:
